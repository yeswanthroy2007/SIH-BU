...
import { TripCard, TripCardTrip } from "../../components/TripCard";
...
export function HomeView({ backgroundImageUrl, trips }: HomeViewProps) {
  return (
    <div className="min-h-screen relative overflow-hidden">
        ...
        <div className="relative z-10 py-24 bg-gray-50/95 backdrop-blur-sm">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex justify-between items-center mb-12">
              <div>
                <h2 className="text-4xl font-bold text-gray-900 mb-2">Recent Trips</h2>
                <p className="text-xl text-gray-600">Join exciting trips planned by fellow travelers</p>
              </div>
              <Link
                to="/trips"
            ...
            {(!trips || trips.length === 0) && (
              <div className="text-center py-16">
                ...
                <h3 className="text-2xl font-semibold text-gray-600 mb-2">No trips yet</h3>
      ...
      <div className="relative z-10 py-24 bg-white">
        <div className="max-w-5xl mx-auto text-center px-4 sm:px-6 lg:px-8">
          <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">Ready to Explore India?</h2>
